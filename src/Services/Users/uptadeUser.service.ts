...
export const updateUserService = async (userData: IUserUpdate, userParamsId: string): Promise<IUserResponse> => {
    ...
    const updatedUserWithoutPassword: any = await responseUsersSerializer.validate(updatedUser, {
        stripUnknown: true
    })
